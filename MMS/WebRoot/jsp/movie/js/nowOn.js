 ...
 */
var nowOnManageCtrl = m.controller("nowOnManagecontroller",function ($rootScope,$scope) {
    ...
    $scope.scenicSortConstFunc = function ($event) {
        ...
        $scope.scenicSortConst = temp;
        $scope.getNowOnMoviePageList();
    };
    /**
     * 设施管理初始化
     */
    $rootScope.nonm_init = function () {
     ...
     * 获取设施分页列表
     */
    $scope.getNowOnMoviePageList = function(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $scope.$apply(function(){
                    ...
                    $scope.nowOnmovieList = new Array();
                    var obj = {};
                    for(var temp in data.page.list){
                        ...
                        if(datestr.getMonth() == (new Date()).getMonth()){
                        	if(datestr.getDay() < (new Date()).getDay()||datestr.getDay() == (new Date()).getDay())
                            {
                            	$scope.nowOnmovieList.push(obj);
    ...
    $scope.addOneOrder = function(item){
